...
The inventory reflects the codebase as of 2026-08-05. Its current shape follows the studio rebuild that replaced the film/develop metaphor with the snap → tray → movie model, and the planning round on 2026-08-03 that moved every edit to *after* generation and added slot templates (`docs/guides/ai-vlog-studio/concept.md`).
