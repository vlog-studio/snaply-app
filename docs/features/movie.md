...
- Playback has no scrubber and no seeking within the movie: the playhead is a read-out, not a control — dragging the strip does not move the stage, and the next position report pulls the strip back under the playhead.
