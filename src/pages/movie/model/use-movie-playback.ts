 ...
 * window. That is the same list the cut list committed, which is the point: the
 ...
 * cut list is where a movie's missing cuts are dealt with; playback can only skip.
 */
