...
export type MovieDeleteConfirmProps = {
  /** The movie the step talks about. */
  movie: MovieSummary;
  onCancel: () => void;
  onConfirm: () => void;
};
...
/**
 * Confirms deleting a movie, and says what stays. The actions sheet's delete
 * step — content only, drawn inside the sheet that is already open.
 *
 ...
 */
export function MovieDeleteConfirm({ movie, onCancel, onConfirm }: MovieDeleteConfirmProps) {
